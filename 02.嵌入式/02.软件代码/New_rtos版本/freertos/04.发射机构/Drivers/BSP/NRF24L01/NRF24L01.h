...
#define NRF24L01_SPI_CS_ENABLE()    HAL_GPIO_WritePin(GPIOA,GPIO_PIN_4,GPIO_PIN_RESET)	//片选
#define NRF24L01_SPI_CS_DISABLE()   HAL_GPIO_WritePin(GPIOA,GPIO_PIN_4,GPIO_PIN_SET)
 
#define NRF24L01_CE_LOW()   HAL_GPIO_WritePin(GPIOA,GPIO_PIN_1,GPIO_PIN_RESET)					//CE
#define NRF24L01_CE_HIGH()  HAL_GPIO_WritePin(GPIOA,GPIO_PIN_1,GPIO_PIN_SET)
 
#define NRF24L01_IRQ_PIN_READ()  HAL_GPIO_ReadPin(GPIOA,GPIO_PIN_0)									//中断
