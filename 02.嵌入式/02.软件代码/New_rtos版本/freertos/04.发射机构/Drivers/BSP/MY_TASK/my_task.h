...
#define light_TASK_SIZE  128              /* 任务堆栈大小 */
extern TaskHandle_t light_TASK_Handler;   /* 任务句柄：仅声明 */
void light_task(void *pvParameters);     /* 任务函数声明 */

/*motor_TASK任务配置 */
#define motor_TASK_PRIO    6             /* 任务优先级 */
#define motor_TASK_SIZE  128              /* 任务堆栈大小 */
extern TaskHandle_t motor_TASK_Handler;   /* 任务句柄：仅声明 */
void motor_task(void *pvParameters);     /* 任务函数声明 */
